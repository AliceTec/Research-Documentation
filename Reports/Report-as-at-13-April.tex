...
\item \textbf{Brain Networks}\\
Our aim in this area is to understand the application of graph theory concepts to Brain networks. Think of how to apply other concepts that have not yet been related to Brain networks. 
